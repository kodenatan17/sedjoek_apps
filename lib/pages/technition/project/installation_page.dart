    ...
    final List<Map<String, dynamic>> allDataPelanggan = [
      {
        ...
        'couponMode': 'none',
        'statusTransaction': 'Installation'
      },
      {
        'addressList': 'Kp Lokomotif RT 05 RW 05 No 40 Kaliabang Tengah',
        'customerList': 'Ferry Natan Wibisono',
    ...
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, index) {
        return CardList(
            ...
            nameTechnician: '${allDataPelanggan[index]["nameTechician"]}',
            hpTechnician: '${allDataPelanggan[index]["hpTechnician"]}',
            ...
            statusTransaction:
                '${allDataPelanggan[index]["statusTransaction"]}');
      },
