...
class ModalSurveyDetail extends StatefulWidget {
  const ModalSurveyDetail({
    Key? key,
    this.selectedPipa,
  ...
  @override
  State<ModalSurveyDetail> createState() => _ModalSurveyDetailState();
...
class _ModalSurveyDetailState extends State<ModalSurveyDetail> {
